    ...
    <section id="section-sobre">
      <div>
        ...
        <p>
          ...
          exclusivos e memoráveis. Nossa missão é criar um espaço onde a
          criatividade não conhece limites e onde você pode se conectar com
          outros entusiastas que compartilham seu amor por animes. Desde
          pequenas reuniões locais até grandes convenções, a AnimeConnect é o
          lugar perfeito para mostrar seu cosplay, fazer novos amigos,
          participar de workshops e mergulhar em tudo relacionado ao anime.
        </p>
      </div>
